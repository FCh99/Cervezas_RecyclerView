...
class DataService {
    ...
    var cervezasInicial = arrayListOf<Cerveza>(
        ...
        Cerveza(4, 5.00, "Woll-Damn", "Woll-Damn", "1/1/2007", "No", "Tercio"),
        Cerveza(5, 4.00, "Cruzcampo", "Cruzcampo", "1/2/2006", "Si", "Lata"),
        Cerveza(6, 5.00, "San Miguel", "San Miguel", "1/3/2007", "No", "Tercio"),
        Cerveza(7, 2.00, "Mahou", "Mahou", "1/1/2004", "Si", "Tercio"),
        Cerveza(8, 3.00, "Coronita", "Coronita", "1/1/2005", "No", "Botellin"),
...
/*
 Cerveza(13, 2.00, "Mahou", "Mahou", "1/1/2004", "Si", "Tercio"),
        ...
        Cerveza(17, 4.00, "Cruzcampo", "Cruzcampo", "1/2/2006", "Si", "Lata"),
        Cerveza(18, 5.00, "San Miguel", "San Miguel", "1/3/2007", "No", "Tercio"),
        Cerveza(19, 2.00, "Mahou", "Mahou", "1/1/2004", "Si", "Tercio"),
        Cerveza(20, 3.00, "Coronita", "Coronita", "1/1/2005", "No", "Botellin"),
        Cerveza(21, 4.00, "Estrella de Galicia", "Estrella de Galicia", "1/1/2006", "Si", "Lata"),
